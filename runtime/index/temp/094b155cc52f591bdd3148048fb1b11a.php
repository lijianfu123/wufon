...
<div class="about-container">
    <div class="wrap">
        <h1 class="plate-title fadeInLeft animated wow">关于我们</h1>
        <h6 class="plate-slogan fadeInRight animated wow">上市公司·品质保证</h6>
        <div class="about-content">
            <?php $Model = new app\common\model\IntroModel();$value = $Model->get_pass_detail(1);$value["intro_detail_url"] = intro_detail_url($value["id"]);?>
                <div class="left">
                    ...
                    <a href="<?php echo htmlentities($value['intro_detail_url']); ?>" class="more">查看更多>></a>
                </div>
...
<div class="solution wrap">
    <h1 class="plate-title">系统解决方案</h1>
...
<div class="product-wrap wrap">
    <h1 class="plate-title fadeInRight animated wow" id="aaaa">系统解决方案</h1>
...
<div class="platform-wrap">
    <h1 class="plate-title">安科瑞云平台</h1>
    <h6 class="plate-slogan">
        上市公司·品质保证
...
<?php if ($app['is_mobile']) { ?>
<div class="product-wrap wrap">
    <h1 class="plate-title fadeInRight animated wow" id="aaaa">安科瑞云平台</h1>
    <h6 class="plate-slogan fadeInLeft animated wow">
        上市公司·品质保证
        <a href="/product_list1.html" style="position: absolute;
            right: 0;
...
<!-- 产品中心 -->
<div class="product-wrap wrap">
    <h1 class="plate-title fadeInRight animated wow" id="aaaa">产品中心</h1>
    <h6 class="plate-slogan fadeInLeft animated wow">
        上市公司·品质保证
...
<div class="case-container">
    <h1 class="plate-title">工程案例</h1>
    <h6 class="plate-slogan">上市公司·品质保证</h6>
    <!--效果html开始-->

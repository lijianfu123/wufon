...
<div class="swiper-container swiper-container1">
    <div class="swiper-wrapper">
        <?php $Model = new app\common\model\SwiperModel();$detail = $Model->get_pass_detail(4);$__list__ = $detail["image_list_json"];if(is_array($__list__) || $__list__ instanceof \think\Collection || $__list__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__list__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
...
<div class="solution-container">
    ...
    <div class="solution-wrap">
        <ul class="switchTab">
            <?php $Model = new app\common\model\NewsModel();$__list__ = $Model->where("(first_news_class_id = 1) or (second_news_class_id = 1)")->order("sort asc, id desc")->select();if(is_array($__list__) || $__list__ instanceof \think\Collection || $__list__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__list__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;$detail_url = "news_detail_url";$value[$detail_url] = news_detail_url($value["id"]); ?>
                <li class="rotateInDownRight animated wow <?php if($value['id'] == $main_detail['id']): ?>aboutPlateCheck<?php endif; ?>">
                    <a href="<?php echo htmlentities($value['news_detail_url']); ?>"><?php echo htmlentities($value['news_name_eng']); ?> <?php echo htmlentities($value['news_name']); ?></a>
                </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
...
<ul class="wrap navigation" style="margin-top: 10px;">
    ...
    <li class="rotateInDownLeft animated wow">
        <span class="selectText"><?php echo htmlentities($main_detail['news_name_eng']); ?> <?php echo htmlentities($main_detail['news_name']); ?></span>
    </li>
</ul>
<!--二级分类-->
...
<div class="detail-wrap solution-wrap wrap">
    <div class="left rotateInDownRight animated wow" style="width: 97% !important;border: 1px solid #05A25F;">
        <img src="<?php echo htmlentities($main_detail['image']); ?>" alt="" style="width: 100%;">
    </div>
    <div class="right rotateInDownLeft animated wow" style="width: 100%;">
        <h3 style="font-size: 20px;"><?php echo htmlentities($main_detail['news_name_eng']); ?> <?php echo htmlentities($main_detail['news_name']); ?></h3>
        <h6>系统功能:</h6>
        <p><?php echo htmlentities($main_detail['gong_neng']); ?></p>
        <h6>应用场所:</h6>
        <p id="content1" style="text-indent: 0;"><?php echo htmlentities($main_detail['fan_wei']); ?></p>
        <!--
        <h6>订货范例:</h6>
...
<ul class="detail product-detail tab_content" style="padding: 20px;">
    <li id="detail_content" style="width: 60%;"><?php echo $main_detail['content']; ?></li>
    <li id="detail_xuan_xing" style="width: 60%;"><?php echo $main_detail['xuan_xing']; ?></li>
    <li id="detail_chi_cun" style="width: 60%;"><?php echo $main_detail['chi_cun']; ?></li>

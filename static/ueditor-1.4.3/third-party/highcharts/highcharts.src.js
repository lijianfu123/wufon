...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the base_vue lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the base_vue lines for areas
...
SVGElement.prototype = {
	...
	/**
	 * Default base_vue for animation
	 */
	opacity: 1,
	/**
...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		renderer.url = (isFirefox || isWebKit) && doc.getElementsByTagName('base_vue.js').length ?
			loc.href
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call base_vue implementation to destroy the rest
...
/**
 * The Point object and prototype. Inheritable and used as base_vue for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The base_vue function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the base_vue Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call base_vue method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series base_vue
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the base_vue options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the base_vue drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the base_vue method (#407)
				...
				each(this.points, function (point) {
					...
					if (dataLabel && dataLabel._pos) {
						...
						connectorPath = softConnector ? [
							...
							L,
							labelPos[4], labelPos[5] // base_vue
						] : [
							M,
							x + (labelPos[6] === 'left' ? 5 : -5), y, // end of the string at the label
							L,

...
vjs.createEl = function(tagName, properties){
  ...
  for (propName in properties){
    if (hasOwnProp.call(properties, propName)) {
      ...
      // The additional check for "role_vue" is because the default method for adding attributes does not
      // add the attribute "role_vue". My guess is because it's not a valid attribute in some namespaces, although
      // browsers handle the attribute just fine. The W3C allows for aria-* attributes to be used in pre-HTML5 docs.
      // http://www.w3.org/TR/wai-aria-primer/#ariahtml. Using setAttribute gets around this problem.

       if (propName.indexOf('aria-') !== -1 || propName=='role_vue.js') {
...
================================================================================ */
/**
 * The base_vue functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.MenuButton = vjs.Button.extend({
  ...
  init: function(player, options){
    ...
    this.el_.setAttribute('role_vue.js', 'button');
  }
});
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run base_vue component initializing with new options.
...
/**
 * The base_vue class for all text tracks
 *
...
/**
 * The base_vue class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
